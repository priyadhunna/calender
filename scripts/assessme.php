...
try {
    ...
    if ($document["Gender"] == "male") {
        ...
        if ($document["bmi"] >= 18.5 && $document["bmi"] <= 24) {
            ...
            $assess .= "<td height=\"170\" width=\"200\"><center><img src=\"icons/bmigreen.png\" height=\"50\" width=\"50\"></center><br><center><input type=\"text\" size=\"10\" value=' " . $document["bmi"] . " ' ></center><big></big></td>";
            
        } else {
            $assess .= "<td height=\"170\" width=\"200\"><center><img src=\"icons/bmi orange.png\" height=\"50\" width=\"50\"></center><br><center><input type=\"text\" size=\"10\" value=' " . $document["bmi"] . " ' ></center> <big></big></td>";
        ...
        if ($document["visceralfat"] >= 1 && $document["visceralfat"] <= 9) {
            $assess .= "<td height=\"170\" width=\"200\"><center><img src=\"icons/visceralfatgreen.png\" height=\"50\" width=\"50\"></center><br><center><input type=\"text\" size=\"10\" value=' " . $document["visceralfat"] . " '></center><big></big></td>";
...
<big></big></td>";
        ...
        if ($document["bmi"] >= 18.5 && $document["bmi"] <= 24) {
            ...
            $assess .= "<td height=\"170\" width=\"200\"><center><img src=\"icons/weight orange.png\" height=\"50\" width=\"50\"></center><br><center><input type=\"text\" size=\"10\" value=' " . $document["weight"] . " ' ></center><big></big></td>";
  ...
  <center> <input type=\"text\" size=\"10\" value=' " . $document["bodywater"] . " ' ></center><big></big> </td>";
        ...
        if ($document["age"] >= 18 && $document["age"] <= 29) {
            ...
            if ($document["bmr"] >= 24.0 * $document["weight"]) {
                ...
                $assess .= "<td height=\"170\" width=\"200\"><center><img  src=\"icons/bmrgreen.png\" height=\"70\" width=\"50\"></center><br><center><input type=\"text\" size=\"10\" value=' " . $document["bmr"] . " '> </center><big><br></big><font size=\"500\"> </td>";
            } else {
...
<big><br></big><font size=\"500\"> </td>";
    ...
    if ($document["Gender"] == "female") {
        ...
        if ($document["bmi"] >= 18.5 && $document["bmi"] <= 24) {
            ...
            $assess .= "<td height=\"170\" width=\"200\"><center><img src=\"icons/bmi orange.png\" height=\"50\" width=\"50\"></center><br><center><input type=\"text\" size=\"10\" value=' " . $document["bmi"] . " ' ></center> 
