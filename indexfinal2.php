          ...
          <a href="#" data-dismiss="modal" class="btn">Close</a>
            ...
            <div class="box-body chat" id="diet-box">
              ...
              <div class="item">
                ...
                <p class="message">
                  <a class="name">
                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> 7:00AM-9:00AM</small>
                    
                    
                    <h2 align="justify"><i><b>&nbsp &nbsp &nbsp &nbsp  Breakfast</b></i></h2>
                  </a><br><pre><h4>Eggs
Cereals
Milk<h4>
                      </pre>
              ...
              <!-- chat item -->
               <div class="item">
                ...
                <p class="message">
                  <a class="name">
                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> 1:00PM-3:00PM</small>
                    
                    <h2 align="justify"><i><b>&nbsp &nbsp &nbsp  Lunch</b></i></h2>
...
Black Channa and Coconut Stew</h4>
             ...
             <div class="item">
                ...
                <p class="message">
                  <a class="name">
                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> 8:00PM-10:00PM</small>
                    

                    <h2 align="justify"><i><b>&nbsp &nbsp &nbsp &nbsp Dinner</b></i></h2>
