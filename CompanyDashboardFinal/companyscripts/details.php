      ...
      <ul class="sidebar-menu">
        ...
        <li>
          ...
          <a href="employee.html">
            ...
            <span class="pull-right-container">
              <small class="label pull-right bg-red">230</small>
         ...
         <li>
          <a href="#">
            <i class="fa fa-users"></i> <span>Upgrade To Pro</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right"></i>
            </span>
          </a>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Employee DataBase</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
$diet = "<table id=\"example2\" class=\"table table-bordered table-hover\" >
                                    <thead>
                                    <th>Name</th>
                                       <th>Name</th>
                                       <th>Points</th>
